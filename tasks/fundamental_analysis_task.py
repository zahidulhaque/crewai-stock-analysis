...
fundamental_analysis_task = Task(
    description=(
        ...
        "   - Fair value range based on fundamental analysis (not external price targets for Indian stocks)\n"
        "   - Risk factors specific to the market and company\n"
        "   - Investment thesis tailored to market characteristics\n\n"
        
        "**Critical Note for Indian Stocks**: Do not rely on external price targets. Calculate fair value "
        "based on fundamental analysis, peer comparison, and market multiples."
    ),
